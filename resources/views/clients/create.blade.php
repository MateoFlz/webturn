@extends('layouts.app', ['activePage' => 'new_client', 'titlePage' => __('Nuevo Cliente')])
...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('clientes.authstore') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    <div class="card ">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('telefono') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}"
                                            ...
                                            placeholder="{{ __('Telefono') }}" value="{{ old('telefono') }}"
                                            required />
