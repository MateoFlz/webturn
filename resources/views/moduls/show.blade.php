@extends('layouts.app', ['activePage' => 'edit_modulo', 'titlePage' => __('Ver datos del modulo')])
                ...
                <form method="post" action="{{ route('modulo.update', $modulos[0]->id) }}" autocomplete="off"
                    ...
                    <div class="card ">
                        <div class="card-header card-header-success">
                            <h4 class="card-title">{{ __('Mostrar Modulo') }}</h4>
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <a class="btn btn-success" href="{{ route('modulo.index') }}">{{ __('Regresar') }}</a>
                        </div>
                    </div>
                </form>
            </div>
