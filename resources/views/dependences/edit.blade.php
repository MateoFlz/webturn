@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Editar dependencias')])
            ...
            <form method="post" action="{{ route('dependencia.update', $dependencia->id) }}" autocomplete="off" class="form-horizontal">
                ...
                <div class="card ">
                    <div class="card-header card-header-success">
                        <h4 class="card-title">{{ __('Editar Dependencia') }}</h4>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control" name="descripcion" id="" cols="4" rows="3" style="font-size:1.7rem;">{{ old('name', $dependencia->descripcion) }}</textarea>
